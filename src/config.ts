...
export const defaultConfig = {
  ...
  plugins: {
    ...
    'connect': path.join(pluginDirectory, 'plugin-connect'),
    'express': path.join(pluginDirectory, 'plugin-express'),
    'generic-pool': path.join(pluginDirectory, 'plugin-generic-pool'),
    'grpc': path.join(pluginDirectory, 'plugin-grpc'),
    'hapi': path.join(pluginDirectory, 'plugin-hapi'),
    'http': path.join(pluginDirectory, 'plugin-http'),
    'http2': path.join(pluginDirectory, 'plugin-http2'),
    'knex': path.join(pluginDirectory, 'plugin-knex'),
    'koa': path.join(pluginDirectory, 'plugin-koa'),
    'mongodb-core': path.join(pluginDirectory, 'plugin-mongodb-core'),
    'mysql': path.join(pluginDirectory, 'plugin-mysql'),
    'mysql2': path.join(pluginDirectory, 'plugin-mysql2'),
    'pg': path.join(pluginDirectory, 'plugin-pg'),
    'redis': path.join(pluginDirectory, 'plugin-redis'),
    'restify': path.join(pluginDirectory, 'plugin-restify')
  },
  stackTraceLimit: 10,
